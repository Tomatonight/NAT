...
void parse_msg(struct MSG_RULE *msg)
{
    ...
    case MSG_ACTION_DELETE_ACL_RULE:
        ...
        break;
    case MSG_ACTION_START_SNAT:
        start_snat(msg->sip);
        break;
    case MSG_ACTION_STOP_SNAT:
        stop_snat();
        break;
    case MSG_ACTION_ADD_DNAT:
        add_entry(htonl(msg->sip), htons(msg->sport), htonl(msg->dip), htons(msg->dport));
        break;
    case MSG_ACTION_DELETE_DNAT:
        delete_entry(htonl(msg->sip), htons(msg->sport), htonl(msg->dip), htons(msg->dport));
        break;
