...
int init_hookfunc(void)
{
    ...
    hook_nat_in.hooknum = NF_INET_PRE_ROUTING;
    hook_nat_out.hooknum = NF_INET_POST_ROUTING;
    ////////////////
    ...
    //////////////
    hook_input.priority = NF_IP_PRI_FIRST+1;
    hook_forward.priority = NF_IP_PRI_FIRST+1;
    hook_output.priority = NF_IP_PRI_FIRST+1;
    hook_post_routing.priority = NF_IP_PRI_FIRST+1;
    hook_pre_routing.priority = NF_IP_PRI_FIRST+1;

    hook_nat_in.priority = NF_IP_PRI_FIRST;
